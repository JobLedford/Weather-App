    ...
    <div className="App">
      ...
      <div className="container">
        ...
        <div className="card mt-3 mx-auto">
          {/* Is it true data coming in from open weathe rbased on input location */}
          {apiData.main
          ? (<div class="card-body text-center">
            ...
            <p className="h5">
              <FontAwesomeIcon
                icon={faMapMarkerAlt}
                className="fas fa-lx mr-2 text-dark"
              />{' '}
              ...
              <div className="col-md-6">
                <p>
                  <FontAwesomeIcon
                    ...
                    className="fas fa-lx mr-2 text-primary"
                  />{' '}
                  <strong>
                ...
                <p>
                  <FontAwesomeIcon
                    ...
                    className="fas fa-lx mr-2 text-danger"
                  />{' '}
                  <strong>
          ...
          : (<h1>Loading...</h1>)} {/* Ouput message if false */}
        </div>
      </div>
